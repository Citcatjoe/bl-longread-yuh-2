(function($){
    ...
    data = [
        ...
        },
        {
            ...
            content: '<span class="lettrine mb-6">Dans un article paru dans la revue 2023 de la Commission fédérale pour les questions féminines (CFQF), l’économiste et mathématicienne Monika Bütler explique que les femmes possèdent en général moins de connaissances financières de base que les hommes.</span><span class="mb-6">Depuis quelques années, la question de l’éducation financière au féminin intéresse en effet de plus en plus les chercheurs mais également la société civile à l’origine de l’arrivée de plateformes d’un nouveau genre destinées aux femmes souhaitant parler d’argent. Parmi elles, on peut citer la newsletter Plan Cash, des ouvrages comme Aux thunes citoyennes ou encore l’excellent podcast Girls That Invest.</span><span>Chez Yuh, on observe que les femmes ont décidemment pris la main sur leurs finances personnelles puisqu’elles représentent en 2024 65% des « Yuhsers » actifs. Mieux : elles sont à présent 40% à investir régulièrement sur l’app. </span>'
        },
        {
            indexDesktop: 10,
            indexMobile: 12,
    ...
    $('.elem').on('click', function() {
        if (!elemTxt)
        {
            ...
            $('.grid .elem:eq(' + (targetE-1) + ')').after('<div class="elem-txt is-collapsed antialiased rounded-xl md:rounded-3xl col-span-2 md:col-span-4 relative pr-12"><img src="../img/this/close-black.svg" id="elem-txt-close" class="absolute cursor-pointer w-6 top-7 right-7"><div class="elem-txt-wrapper"><div class="elem-txt-wrapper-inner grid grid-cols-1">' + matchingElement.content + '</div></div></div>');
