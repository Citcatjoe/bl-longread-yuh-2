(function($){
    ...
    data = [
        ...
        },
        {
            ...
            content: '<span class="lettrine mb-6">Parmi les compétences les plus recherchées dans le monde du travail actuel, on retrouve en bonne place la programmation informatique, aussi appelé <i>coding</i> par les initiés. Mais qu’est-ce que ça veut dire au juste, coder? Afin d’y voir un peu plus clair, Blick est allé rendre visite à Swissquote, qui, rappelez-vous, met à disposition son infrastructure technique pour Yuh. <i>Technical Project Manager</i> au sein de la banque installée, elle aussi, à Gland, Baptiste Mondehard compare la programmation informatique à un travail de traduction où l’humain explique à un système (une app dans le cas de Yuh) comment effectuer une action donnée dans un langage que celui-ci comprend.</span><span>Ainsi, chaque action, même la plus petite, est régie par ce que l’on appelle des lignes de codes venant donner des instructions à la machine. Constant «<i>work-in-progress</i>» le code nécessite des mises à jour fréquentes, appelées <i>commits</i>, afin de continuer à faire fonctionner le système correctement, d’assurer une cohérence technique sur le long terme… mais aussi de challenger l’esprit et la créativité des développeurs!</span>'
        },
        {
            indexDesktop: 6,
            indexMobile: 4,
        ...
        },
        {
            ...
            label2FontSize: 'text-xl md:text-4xl lg:text-2xl xl:text-4xl',
            content: '<span class="lettrine mb-6">Ah, la Suisse… ses montagnes, ses prairies et bien sûr…son chocolat! Plus grands consommateurs au monde, les Helvètes sont également les plus importants producteurs de cette douceur irrésistible obtenue à partir des fèves de cacao. Blanc, au lait, noir ou même ruby, notre or brun est apprécié partout dans le monde et donne le sourire aux chocolatiers (et pas uniquement en raison des effets antidépresseurs que certaines études prêtent au cacao, si vous voyez ce que je veux dire).</span><span class="mb-6">A ce stade, et rusés comme vous êtes, il est possible que vous envisagiez de mettre la main sur quelques actions d’entreprises renommées dans le domaine. C’est alors que vous découvrez que Yuh propose justement des actions du maître chocolatier Lindt. Problème: lorsque que vos yeux s’attardent sur le prix, vous constatez avec effroi que pour être propriétaire <i>d’une seule</i> action, il vous faudrait débourser pas moins de 106’200 francs!</span><span class="mb-6">Alors, à la poubelle, vos rêves d’investissement? Pas si vite. Afin de démocratiser le trading même lorsque l’on ne s’appelle pas Warren Buffet, Yuh a mis en place un système de <i>fractional trading</i> permettant d’acquérir un petit bout de cette action dès 25 chf. Vous reprendrez bien un petit carré de chocolat?</span><span class="italic">*Valeur de l’action au moment de la rédaction de l’article</span>'
        },
        {
            indexDesktop: 9,
            indexMobile: 8,
        ...
        },
        {
            ...
            content: '<span class="lettrine mb-6">Le 11 mai 2021 et l’issue d’un évènement de lancement virtuel, Covid-19 oblige, les Suisses ont vu débarquer dans leurs <i>stores</i> une application dont l’ambition consistait – tout simplement – à révolutionner la gestion financière mobile. Et une fois sur orbite, plus rien ne semblait pouvoir arrêter la fusée Yuh qui franchit alors la barre des 10’000 inscrits en l’espace de trois semaines.</span><span>En février 2022, le bébé de Swissquote et PostFinance, alors âgé de neuf mois, avait multiplié ce chiffre par cinq. Trois ans après son lancement, Yuh compte désormais plus de 230’000 «Yuhsers» actifs.</span>'
        },
        {
            indexDesktop: 11,
            indexMobile: 11,
            ...
            content: '<span class="lettrine mb-6">En trois ans d’existence, la jeune pousse de la finance suisse a su s’entourer d’une équipe de talents animés par une soif d’innovation et de créativité. Issus de tous horizons, ces «Yuhmains» sont répartis entre les deux bureaux de Yuh à Gland et à Zurich et s’occupent entre autres:</span><ul class="list-disc w-3/4 mx-auto"><li><b>Du marketing:</b> ceux qui s’attellent chaque jour à faire rayonner Yuh</li><li><b>Du développement de nouvelles fonctionnalités:</b> les cerveaux derrière toutes les nouveautés de Yuh: l’intégration de Twint, les investissements récurrents ou encore la carte virtuelle, ce sont eux!</li><li><b>Du <i>customer care</i>:</b> lorsque vous avez égaré votre carte, que vous avez oublié vos identifiants ou encore que vous paniquez, car vous ne trouvez pas trace d’un paiement, ce sont eux que vous avez au téléphone.</li></ul>'
        },
        {
            indexDesktop: 12,
            indexMobile: 10,
        ...
        },
        {
            ...
            content: '<span class="lettrine mb-6">Alors que les pics d’activité sur Yuh se situent entre 9h et midi puis à nouveau à partir de 17h, on trouve tout de même en moyenne un demi-millier de «Yuhsers» connectés sur l’app aux alentours de 3h du matin! Mais que peuvent-ils bien y faire alors même que les marchés, eux, dorment à poings fermés?</span><span>Si on peut penser que ces oiseaux de nuit sont en réalité des fans de cryptomonnaies (qui peuvent être <i>tradées</i> 24h sur 24 et 7 jours sur 7) ou encore des fêtards désireux de connaître leur solde de carte après une soirée clubbing, on profite tout de même de l’occasion pour attirer leur attention sur l’importance de dormir suffisamment, de préférence entre 7 et 9 heures par nuit.</span>'
        },
        {
            indexDesktop: 14,
            indexMobile: 15,
            ...
            content: '<span class="lettrine">En décembre 2022, les «Yuhmains» ont calculé qu’en moyenne, Yuh avait lancé une nouvelle fonctionnalité tous les 38 jours. Ordres permanents, factures <i>eBill</i>, solutions de paiement mobile, <i>fractional trading</i>, ou quand une néo-banque prend des allures de ruche.</span>'
        },
        {
            indexDesktop: 15,
            indexMobile: 14,
        ...
        },
        {
            ...
            content: '<span class="lettrine mb-6">«<i>Started from the bottom, now we’re here</i>», chantait le rappeur canadien Drake en 2013. Un hymne à celles et ceux qui atteignent la réussite en partant de zéro et qui résume également bien la progression de la popularité de Yuh.</span><span>Selon une étude de marché mesurant la notoriété de Yuh en 2021, seuls 14% des Suisses avaient déjà entendu parler de la toute jeune néo-banque créée en mai de la même année. Un an plus tard, ce chiffre avait grimpé à 28% pour enfin arriver à 46% en 2023.</span>'
        },
        {
            indexDesktop: 18,
            indexMobile: 16,
